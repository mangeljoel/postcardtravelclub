...
import MemoriesCard from "../../MyCollections/MemoriesCard";
...
const MemoriesTextCard = ({ profile }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                by adding photos to your collected postcards.
            </Text>
...
const MemoriesSection = ({ featuredMemories }) => {
    ...
    return (
        ...
        >
            ...
            <Box display={["block", "none"]}>
                <MemoriesTextCard profile={profile} />
            </Box>
            <Box position={"relative"} w="100%">
                ...
                >
                    ...
                    >
                        ...
                        <ChakraNextImage
                            src="/assets/homepage/cards/postcard_memories.png"
                            w={["100%", "314px", "314px", "25vw"]}
                            minW={["85vw", "35vw", "30vw", "25vw"]}
                            h={["480px", "514px", "514px", "36vw"]}
                            ...
                            noLazy
                            cursor="pointer"
                            onClick={() => { window.open("/amitjaipuria", "_blank") }}
                        />
                        ...
                        {/* <Flex flexDirection={"column"}
                            ...
                            >
                                ...
                                >
                                    <ChakraNextImage
                                        src="/assets/landingpage/interest_5.jpeg"
                                        w="100%"
                                        h="100%"
                                        objectFit="cover"
                                        borderRadius={["4.167vw", "1.597vw"]}
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        onClick={() => { profile ? router.push(`/${profile.slug}`) : openLoginModal() }}
                                    >
                                        View All
                                    </Button>
                                </Flex>
