...
import { Box, Button, Flex, Icon, IconButton, Image, Text, useDisclosure } from '@chakra-ui/react';
import { CalendarIcon, FlipIcon, FolderIcon, WebsiteIcon } from '../../styles/ChakraUI/icons';
...
import { createDBEntry, fetchPaginatedResults } from '../../queries/strapiQueries';
import AppContext from '../AppContext';
import { ChakraNextImage } from '../../patterns/ChakraNextImage';

const DxCard = ({ data, canEdit, handleDelete, setDxCardMemory, openEditForm, canSelect = false, canRemove = false, isSelected = false, allowImageUpload = false, onImageUpload = () => { }, carouselMedia = [], dragHandleProps, isDragging, checkboxClick = () => { }, unselectCard = () => { }, changeDateCard = () => { }, openAiDetails = () => { }, firstLoad = false, setFirstLoad = () => { } }) => {
    ...
    // }
    // } />
    const createDxCardMemory = async (data) => {
        let dxCardMem = await fetchPaginatedResults("memories", { dx_card: data?.id, user: profile?.id }, {});
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* {canEdit && <Button
                                        ...
                                        m={0}
                                        minW={["19px", "19px", "19px", "1.46vw"]}
                                        onClick={(e) => { e.stopPropagation(); openEditForm(data?.id) }}
                                    >
                                        <Icon
                                            as={MdEdit}
                                            width={"100%"}
