...
const Restaurants = ({ cards = [], setDxCardMemory, isDx = false, handleRemoveCard, handleChangeDate, handleSave, actionItemProps, allowImageUpload, onImageUpload }) => {
                ...
                >
                    <Flex style={{
                        ...
                        {dxCards?.length > 0
                            ...
                            : <Text fontSize={["3.61vw", "1.875vw"]} fontFamily={"lora"} fontStyle={"italic"} mx={"auto"}>No Restaurants Selected</Text>
                        }
                    </Flex>
                </div>
            </Flex>
