...
const Postcard = ({
    ...
    const { profile, canCreatePostcard, logOut, featuredPostcards, featuredAlbums, updateFeaturedItems } = useContext(AppContext);
            ...
            frontContent={
                <>
                    <Flex
                        ...
                        position={"relative"}
                    >
                        {postcard?.album && postcard?.album?.isFeatured && postcard?.album?.isActive && (
                            ...
                            >
                                {postcard?.tags?.map((tag, index) => (
                                    <Flex
                                        ...
                                        href={`/experiences/interests/${tag.name?.toLowerCase()}`}
                                    >
                ...
                >
                    ...
                    >
                        ...
                        <Flex
                            ...
                            alignItems={"center"}
                        >
                            {(from !== "albumPage" && from !== "toursPage") && postcard?.album?.isActive && postcard?.album?.isFeatured && (
                                <Button
                                    as={Link}
                                    variant="none"
                                    p={0}
                                    ...
                                    href={`/postcard-pages/${postcard?.album?.slug}`}
                                    target={"_blank"}
                                // onClick={(e) => {
                                //     e.stopPropagation()
                                //     addAlbumEvent(profile?.id, postcard?.album?.news_article ? `/postcard-pages/${postcard?.album?.slug}` : postcard?.album?.slug, postcard?.album?.id, postcard?.id)
                                // }}
                                >
                                    <Image
