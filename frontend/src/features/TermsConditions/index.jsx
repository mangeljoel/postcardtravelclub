...
const TermsConditions = () => {
    return (
        ...
        >
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>Effective Date: August 24, 2020</Text>
                    <Text>
                        <i>Website Covered: www.postcard.travel</i>
                    </Text>
                    <Text textTransform="uppercase">
                        <strong>The agreement:</strong> The use of this website
                        and services on this website provided by Postcard Travel
                        (hereinafter referred to as "<strong>Owner</strong>")
                        are subject to the following Terms & Conditions
                        (hereinafter the "<strong>Terms of Service</strong>"),
                        all parts and sub-parts of which are specifically
                        incorporated by reference here. Following are the Terms
                        of Service governing your use of www.postcard.travel
                        (the "<strong>Website</strong>"), all pages on the
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <Text>
                        ...
                        certain Services on it, available to users. Postcard
                        Travel, Owner, Us, We, Our, Ours and other first-person
                        pronouns will refer to the Owner, as well as all
                    ...
                    <Text>
                        ...
                        Terms of Service, the term "<strong>User</strong>" or "
                        <strong>you</strong>" shall mean any natural or legal
                        person who person is accessing the Website. The term '"
                        <strong>Your</strong>" shall be construed accordingly.
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <Text>
                        ...
                        You agree to notify Us immediately in writing. Email
                        ...
                        changes to Your identifying information. Providing false
                        or inaccurate information, or using the Website or
                        Services to further fraud or unlawful activity is
                        grounds for immediate termination of these Terms of
                        Service. The Owner reserves the right to refuse service,
                        terminate accounts, or remove or edit content in its
                        sole discretion.
                    </Text>
                    <Text>
                        We reserve the right to refuse service or refuse to sell
                        the products on the Website at our sole discretion to
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <ul>
                        ...
                        <li>
                            II) To violate any intellectual property rights of
                            the Owner or any third party;
                        </li>
                        <li>
                            III) To upload or otherwise disseminate any computer
                            viruses or other software that may damage the
                            property of another;
                        </li>
                        ...
                        <li>
                            VII) To publish or distribute any material that
                            incites violence, hate or discrimination towards any
                            group;
                        </li>
                        <li>
                    ...
                    <Text>
                        ...
                        communication or other materials that is abusive,
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <Text>
                        You understand that each time use the Website in any
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>9) PRIVACY INFORMATION</strong>
                    </Text>
                    <Text>
                    ...
                    <Text>
                        ...
                        Owner will store information about You.
                    </Text>
                </Box>
            </Box>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>10) REVERSE ENGINEERING & SECURITY</strong>
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>14) THIRD-PARTY LINKS & CONTENT</strong>
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>15) MODIFICATION & VARIATION</strong>
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>17) SERVICE INTERRUPTIONS</strong>
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>18) TERM, TERMINATION & SUSPENSION</strong>
                    </Text>
                    <Text>
                        ...
                        requesting termination. At the termination of these
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>19) NO WARRANTIES</strong>
                    </Text>
                    <Text>
                        ...
                        You, through Your computer system, or as a result of
                    ...
                    <Text>
                        ...
                        usage, or trade practice. Company makes no
                    ...
                    <Text>
                        ...
                        responsible for any content found on the Website.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        ...
                        information in the Service or on any related website has
                    ...
                    <Text>
                        ...
                        this Terms of Service or the Privacy Policy.
                    </Text>
                    <Text>
                        You specifically agree that the Website is not
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    <Text>
                        <strong>20) LIMITATION ON LIABILITY</strong>
                    </Text>
                    <Text>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <Text>
                        ...
                        notices given pursuant to these Terms of Service shall
                        be in the English language.
                    </Text>
                    <Text>
                        <strong>
                            b) JURISDICTION, VENUE & GOVERNING LAW:{" "}
                        </strong>{" "}
                        Through Your use of the Website or Services, You agree
                        that the laws of the India shall govern any matter or
                        dispute relating to or arising out of these Terms of
                        Service, as well as any dispute of any kind that may
                        arise between You and the Owner, with the exception of
                        its conflict of law provisions. In case any litigation
                        specifically permitted under these Terms of Service is
                        initiated, the Parties agree to submit to the exclusice
                        jurisdiction of the courts at Bangalore, India, India.
                        The Parties agree that this choice of law, venue, and
                        jurisdiction provision is not permissive, but rather
                        mandatory in nature. You hereby waive the right to any
                        objection of venue, including assertion of the doctrine
                        of forum non conveniens or similar doctrine.
                    </Text>
                    <Text>
                        <strong>c) ASSIGNMENT:</strong> This Agreement, or the
                        rights granted hereunder, may not be assigned, sold,
                        leased or otherwise transferred in whole or part by You.
                        Should these Terms of Service, or the rights granted
                        hereunder, by assigned, sold, leased or otherwise
                        transferred by the Owner, the rights and liabilities of
                        the Owner will bind and inure to any assignees,
                        administrators, successors and executors.
                    </Text>
                    <Text>
                        <strong>d) SEVERABILITY:</strong> If any part or
                        sub-part of these Terms of Service is held invalid or
                        unenforceable by a court of law or competent arbitrator,
                        the remaining parts and sub- parts will be enforced to
                        the maximum extent possible. In such condition, the
                        remainder of these Terms of Service shall continue in
                        full force.
                    </Text>
                    <Text>
                        <strong>e) NO WAIVER</strong> In the event that We fail
                        to enforce any provision of these Terms of Service, this
                        shall not constitute a waiver of any future enforcement
                        of that provision or of any other provision. Waiver of
                        any part or sub-part of these Terms of Service will not
                        constitute a waiver of any other part or sub-part.
                    </Text>
                    <Text>
                        <strong>f) HEADINGS FOR CONVENIENCE ONLY:</strong>{" "}
                        Headings of parts and sub-parts under these Terms of
                        Service are for convenience and organization, only.
                        Headings shall not affect the meaning of any provisions
                        of these Terms of Service.
                    </Text>
                    <Text>
                        <strong>
                        ...
                        created between the Parties as a result of these Terms
                        of Service. No Party has any authority to bind the other
                        to third parties.
                    </Text>
                    <Text>
                        <strong>h) FORCE MAJEURE:</strong> The Owner is not
                        liable for any failure to perform due to causes beyond
                        its reasonable control including, but not limited to,
                        acts of God, acts of civil authorities, acts of military
                        authorities, riots, embargoes, acts of nature and
                        natural disasters, and other acts which may be due to
                        unforeseen circumstances.
                    </Text>
                    <Text>
                        <strong>i) ELECTRONIC COMMUNICATIONS PERMITTED:</strong>{" "}
                        Electronic communications are permitted to both Parties
                        under these Terms of Service, including e-mail or fax.
                        For any questions or concerns, please email Us at the
                        following address: hello@postcard.com.
                    </Text>
                </Box>
            </Box>
            ...
            <Box mt="2%" mb="2%">
                <Box mt="2%" mb="2%">
                    ...
                    <br />
                    <Text>
                        Starlife Idea Labs Pvt. Ltd., 344/8, 4th main road,
