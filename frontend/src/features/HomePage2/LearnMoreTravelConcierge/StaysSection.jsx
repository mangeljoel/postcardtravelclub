        ...
        >
            ...
            >
                <Text
                    ...
                    lineHeight={["6.67vw", "2.65vw"]}
                >
                    Discover local experiences based on your favourite travel themes and interests.
                </Text>
            ...
            <Button
                ...
                onClick={() => window.open("/experiences/themes", "_blank")}
            >
                View All &nbsp;
                <RightArrowIcon
                    style={{ paddingTop: "1%" }}
...
const StaysSection = ({ featuredAlbums }) => {
    const { profile } = useContext(AppContext);
    const scrollContainerRef = useRef(null);
    const router = useRouter();
    const regions = [
        { region: 'Architecture & Design', imageUrl: 'https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&q=80', link: "/experiences/themes/architecture-and-design" },
        { region: 'Art, Craft & Textile', imageUrl: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&q=80', link: "/experiences/themes/art_craft-and-textile" },
        { region: 'Food & Drink', imageUrl: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=80', link: "/experiences/themes/food-and-drink" },
    ];
