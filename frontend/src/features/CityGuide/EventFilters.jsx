...
const EventFilters = ({ filter, setFilter, callBeforeApply, locationData, locationType }) => {
    ...
    const centerElementInView = () => {
        const element = document.getElementById("EventFilters");
        const modalBody = document.getElementById("EventFiltersBody");
    ...
    return (
        <Box id={"EventFilters"} w={"100%"} px={["0%", "20%"]} position={"relative"} >
            {/* Overlay */}
            {open && (
                <Box
                    position="fixed"
