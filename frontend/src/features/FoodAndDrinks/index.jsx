...
import GuidedSearchFnD from "./GuidedSearchFnD";
// import SelectedTagList from "./SelectedTagList";

const FoodAndDrinks = ({ type, isDiary, slug }) => {
        ...
        <Flex w={"100%"} flexDirection={"column"}>
            ...
            >
                ...
                <Text fontSize={["4.5vw", "1.6vw"]} maxW={"90%"} fontWeight="medium" fontFamily={"lora"}>
                    Find handpicked restaurants that curate culinary experiences
                </Text>
            </Flex>}
            <Box
                pos="relative"
            ...
            >
                ...
                <GuidedSearchFnD filter={filter} isDiary={isDiary} slug={slug} setFilter={setFilter} callBeforeApply={() => { }} />
